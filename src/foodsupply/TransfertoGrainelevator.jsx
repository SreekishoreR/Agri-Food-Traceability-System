...
const TransfertoGrainelevator = () => {
  ...
  const submitdata = () => {
    const value = {
      ...
      file:file,
      remark:"transferred to grain elevator"
    };
    console.log(value);
    axios
    ...
    <div className="row">
      ...
      <div className="col-10" style={{ width: "80%" }}>
        ...
        <div className="form-floating mb-3 mt-3">
          ...
          <label htmlFor="seedname">Select Grain_Elevator</label>
        </div>
        <div className="form-floating mb-3 mt-3">
          <input
            list="browsers1"
...
export default TransfertoGrainelevator;
